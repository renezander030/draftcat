...
`fixclaw test <pipeline>` reads files from `fixtures/<pipeline>/` to dry-run a pipeline without touching real connectors, the LLM, or the operator channel.
